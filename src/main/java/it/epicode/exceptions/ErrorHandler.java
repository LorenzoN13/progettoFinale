...
import it.epicode.responses.ErrorResponse;
...
public class ErrorHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ErrorResponse EventFullException(EventFullException e){
        return new  ErrorResponse(e.getMessage());
    }

    @ExceptionHandler(BookingConflictException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ErrorResponse BookingConflictException(BookingConflictException e){
        return new  ErrorResponse(e.getMessage());
    }
}
